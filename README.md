...
*   **Model Fitting:** Fitting code is provided in both Python  (under `\modelling_python\`) and MATLAB  (under `\modelling_matlab\`).
    *   **Python:** `fitModels.ipynb`: This notebook contains the python version of the the models used to generate Figure 3 and Supplementary Figure 4.
			  `FigureFitRichnessExperiment1_supplementary.ipynb`: Run this notebook to generate the visualisations.
			  These scripts were developed and tested using Python 3.11
    *   **MATLAB:** 
